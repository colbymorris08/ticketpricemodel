...
| **Secondary market listings** | Price, section, quantity, timestamp | **StubHub** (UK HTTP + US Playwright — [`docs/STUBHUB_SCRAPING.md`](STUBHUB_SCRAPING.md)), SeatGeek API optional |
